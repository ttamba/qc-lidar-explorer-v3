          ...
          if (status.status === "completed") {
            setInfoMessage(
              status.zip_path
                ...
                : `Dossier prêt QGIS généré : ${(status as LocalAgentJobStatus & { output_dir?: string }).output_dir ?? "voir dossier local"}`
            );
          ...
          <div style={{ display: "grid", gap: 10 }}>
            ...
            <label style={{ display: "grid", gap: 6, fontSize: 12, color: "#374151" }}>
              ...
              <select
                ...
                onChange={(e) =>
                  updateLocalAgentSettings({ outputMode: e.target.value as "zip" | "folder" })
                }
                style={{
                  padding: 8,
                  borderRadius: 8,
                ...
                disabled={!!localExportJobId}
              >
                <option value="zip">ZIP (téléchargement)</option>
                <option value="folder">Dossier prêt QGIS</option>
              </select>
            </label>
            ...
            <StatusCard tone="info">
              ...
              <strong>
			   {localAgentSettings.outputMode === "folder"
				? "Dossier prêt QGIS"
				: "ZIP téléchargeable"}
			  </strong>
              </StatusCard>
